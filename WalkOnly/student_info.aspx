<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="student_info.aspx.cs" Inherits="WalkOnly.student_info" %>
    ...
    <div class=" col-md-8 mx-auto mt-5">
        ...
        <section class="jumbotron ">
            <div class="container text-justify">
                ...
                <span>011</span>
                <br />
                <h5 class="d-inline">Application's status: </h5>
                <span>Pending</span>
                <br />
                ...
                <p>
                    <br />
                    <a href="Dashboard.aspx" class="btn btn-success my-2 float-right ml-1">APPROVE</a>
                    <a href="Dashboard.aspx" class="btn btn-danger my-2 float-right ml-1">DENY</a>
                    <a href="Dashboard.aspx" class="btn btn-secondary my-2 float-right ml-1">GO BACK</a>
                </p>
            </div>
        </section>
    </div>
