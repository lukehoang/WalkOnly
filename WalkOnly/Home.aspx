    ...
    <div class=" col-md-8 mx-auto mt-5">
        <section class="jumbotron ">
            <div class="container text-justify">
                <h2 class="text-center jumbotron-heading">University Commencement “Walk Only” Petition System</h2>
                ...
                <ol>
                    <li><strong>Petitions must be submitted by the University graduation application deadline for the
                            ...
                            website of the Office of the University Registrar (<a href="www.temple.edu/registrar" target="_blank">www.temple.edu/registrar</a>).</li>
                ...
                <br />
                <br />
                <h5 class="text-center">NOTE: Tickets to the ceremony/ies for guests will be assigned on a space-available basis.
                </h5>
                <br />
            ...
            <p>
                <br />
                <a href="status.aspx" class="btn btn-secondary my-2 float-right ml-1">APPLICATION'S STATUS</a>
